        ...
        <div class="container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="./php/profile.php"><i class="fas fa-dashboard "></i>Settings</a></li> <!-- Profile Icon Added -->
                    <li><a href="index.php"><i class="fas fa-user"></i> Profile</a></li> <!-- Profile Icon Added -->
                </ul>
            </nav>
        </div>
    </header>
